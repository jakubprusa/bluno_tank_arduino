    ...
    if(val!=-1)
       {
          switch(val)
           {
             case 'w'://Move ahead
                        Motor1(150,true);  //You can change the speed, such as Motor(50,true)
                        Motor2(150,false);
                        val = Serial.write("Moving forward\n");
                         break;
             case 'x'://move back
                        Motor1(150,false);  //You can change the speed, such as Motor(50,true)
                        Motor2(150,true);
                        val = Serial.write("Moving back\n");
                         break;
             case 'a'://turn left
                        Motor1(150,true);
                        Motor2(150,true);
                        val = Serial.write("Moving left\n");
                         break;       
             case 'd'://turn right
                        Motor1(150,false);
                        Motor2(150,false);
                        val = Serial.write("Moving right\n");
                        break;   
               case 's'://stop
                        Motor1(0,false);
                        Motor2(0,false);
                        val = Serial.write("Stoping\n");
                         break;
